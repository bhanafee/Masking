 ...
 *
 * <ul>
 *   <li>Segment-based validation and parsing
 *   <li>Masked rendering with delimiter preservation
 *   <li>Factory method for parsing ambiguous TIN formats
 * </ul>
 *
 * <p>Subclasses define the specific segment structure for their TIN type. Currently supported types
 * are {@link SSN} and {@link EIN}.
 *
 * <h2>Rendering</h2>
 *
