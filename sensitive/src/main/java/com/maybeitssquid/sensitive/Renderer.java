...
/**
 * Renders sensitive data as a {@link CharSequence} with appropriate redaction. Implementations
 * control how much information is revealed based on formatting parameters.
 *
 ...
 *
 * <ul>
 *   <li>{@code precision = -1}: Default behavior (typically shows half the data,
 *       implementation-dependent)
 *   <li>{@code precision >= 0}: Number of unredacted segments/characters to show (e.g., for SSN
 *       "123-45-6789", precision=4 shows last 4 digits: "***-**-6789")
 * </ul>
 *
 ...
 * <h2>Usage</h2>
 *
 * Renderers are typically used by subclasses of {@link Sensitive} that override {@link
 * Sensitive#getRenderer()} to provide a shared renderer instance:
 *
 * <pre>{@code
...
public interface Renderer<T> {
   ...
   * disclosed.
   *
   * <p>This is the default renderer used by {@link Sensitive#getRenderer()} and provides maximum
   * protection by revealing nothing about the contained value.
   *
