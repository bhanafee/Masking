 ...
 *
 * <ul>
 *   <li>A TIN string does not match the expected format
 *   <li>A TIN segment value is outside the valid range
 *   <li>A null value is provided where a TIN is required
 * </ul>
 *
